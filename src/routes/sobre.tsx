      ...
      <SectionCard title="Visite a loja">
        <div className="grid sm:grid-cols-2 gap-6 not-prose">
          <div className="space-y-3 text-sm">
            <p className="inline-flex items-start gap-2"><MapPin size={16} className="text-primary mt-0.5 shrink-0" /> <span>Rua das Cegonhas, 699 — Jardim Iririú<br />Joinville/SC · CEP 89227-645</span></p>
