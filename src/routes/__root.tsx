...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "MT Mobilidade — Motos e Scooters Elétricas em Joinville" },
      ...
      { property: "og:title", content: "MT Mobilidade — Motos e Scooters Elétricas em Joinville" },
      ...
      { name: "twitter:title", content: "MT Mobilidade — Motos e Scooters Elétricas em Joinville" },
